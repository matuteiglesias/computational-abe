...
public class Parameters {
	...
	public final static float AGENT_FIRM_CAPITAL_FRAC_ADELANTO = 0.5F;
	public final static float AGENT_FIRM_CAPITAL_MARGIN = 3F;
	...
	public final static float AGENT_FIRM_CONSUMER_MARGIN = 0.2F;
	public final static float AGENT_FIRM_CONSUMER_CAPITAL_INTENSITY = 0.4F;
	public final static int AGENT_FIRM_CONSUMER_NW = 1000;
	...
	public final static int CYCLES = 600;
	public final static int SIMULATIONS = 1;
	
	// AgentFirmCapital
	public final static int SEND_BROCHURE = 5;
